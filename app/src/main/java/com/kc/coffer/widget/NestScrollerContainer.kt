...
open class NestScrollerContainer @JvmOverloads constructor(
    ...
    override fun onStartNestedScroll(child: View, target: View, axes: Int, type: Int): Boolean {
        Log.i(
            TAG,
            "onStartNestedScroll  axes : $axes ,type : $type"
        )
    ...
    override fun onNestedScrollAccepted(child: View, target: View, axes: Int, type: Int) {
        Log.i(
            TAG,
            "onNestedScrollAccepted  axes : $axes ,type : $type"
        )
        if (animator == null) {
...
//                        ceil(scrollY.toDouble()) == (2 * MAX_HEIGHT).toDouble()) && !isFirstRunAnim
//            ) {
//                var startY = 0
//                if (dyUnconsumed > 0) {
...
//    }
    ...
    private inner class ReboundAnimator : ValueAnimator() {
        ...
        fun startOfFloat(target: View, startY: Float) {
            this.setFloatValues(startY, MAX_HEIGHT.toFloat())
            this.target = target
            this.start()
        }
    }
